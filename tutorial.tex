...
List \ref{lst:latex-text-size} shows available \LaTeX{} text size.
...
\begin{center}
  \verb|\includegraphics[scale=0.5]{myimg}|
...
We could also use \textit{aligned} environment to achieve the same
